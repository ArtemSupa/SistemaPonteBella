 ...
 * @author ArtemSupa
 */
public class MenuAjustes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rSButtonBigIcon_new1.setText("Mantenedor Categoria de Producto");
        ...
        rSButtonBigIcon_new1.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.BUILD);
        ...
        rSPanelMaterial1.add(rSButtonBigIcon_new1, new org.netbeans.lib.awtextra.AbsoluteConstraints(322, 171, 230, 190));
    ...
    private void rSButtonBigIcon_new1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonBigIcon_new1ActionPerformed
        Crud_Categoria crud = new Crud_Categoria();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuAjustes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuAjustes().setVisible(true);
            }
        });
    }
