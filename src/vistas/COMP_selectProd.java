 ...
 * @author ArtemSupa
 */
public class COMP_selectProd extends javax.swing.JFrame {

    
    /**
     * Creates new form COMP_selectProd
     */
    public COMP_selectProd() {
        initComponents();
        LlenaGrilla();
...
public void LlenaGrilla(){
    ...
    private void tbl_productosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_productosMouseClicked
       if(evt.getClickCount()==2){
            ...
            String PrecioProd = String.valueOf(tbl_productos.getValueAt(seleccionar, 2));
            String NombreProd = String.valueOf(tbl_productos.getValueAt(seleccionar, 1));
            String CantidadProd = JOptionPane.showInputDialog("Ingrese la cantidad a comprar");
                ...
                if(CantidadProd.isEmpty()==false){
                    if(CantidadProd.trim().equals("")){
                        ...
                        if (m.find()) {
                            ...
                            IngresoMercaderiaDetalle ingMerDet = new IngresoMercaderiaDetalle();
                            ...
                            COMP_ingeComp.modeloLista2.addRow(vi);
                            String precioCompra="";
                            String Cantidad="";
                            
                            for(int i = 0 ; i < COMP_ingeComp.modeloLista2.getRowCount();i++){
        
                                Cantidad = (String) COMP_ingeComp.modeloLista2.getValueAt(i,2);
                                precioCompra = (String) COMP_ingeComp.modeloLista2.getValueAt(i,3);
                            ...
                            String TraerValorTXT = COMP_ingeComp.txt_subtotalV.getText();
                            ...
                            COMP_ingeComp.txt_subtotalV.setText(SubtotalFinalS);
                            String ValorDescuento = COMP_ingeComp.txt_descuentoV.getText();
                            int ValorDesc = Integer.parseInt(ValorDescuento);
                            int ValorFinalDesc = SubtotalFinal-ValorDesc;
                            String TotalFinal = String.valueOf(ValorFinalDesc);
                            COMP_ingeComp.txt_totalV.setText(TotalFinal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(COMP_selectProd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new COMP_selectProd().setVisible(true);
            }
        });
    }
