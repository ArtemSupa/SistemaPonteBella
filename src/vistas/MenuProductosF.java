 ...
 * @author ArtemSupa
 */
public class MenuProductosF extends javax.swing.JFrame {

    /**
     * Creates new form MenuProductosF
     */
    int x,y;
    public MenuProductosF() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        rSButtonBigIcon_new1.setText("Ingresar producto");
        ...
        rSButtonBigIcon_new2.setText("Ver productos");
        ...
        rSButtonBigIcon_new3.setText("Editar Productos");
    ...
    private void rSButtonBigIcon_new1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonBigIcon_new1ActionPerformed
        PROD_ingreProd ingrProds = new PROD_ingreProd();
        ingrProds.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuProductosF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuProductosF().setVisible(true);
            }
        });
    }
