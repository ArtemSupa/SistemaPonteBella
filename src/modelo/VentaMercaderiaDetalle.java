 ...
 * @author ArtemSupa
 */
public class VentaMercaderiaDetalle {
    ...
    public VentaMercaderiaDetalle() {
    }

    public VentaMercaderiaDetalle(int idDetalleVenta, int detaCantidad, int detaPrecio, String prodCodigo, int idVenta) {
